...
function(target_add_protobuf target)
    ...
    get_filename_component(PROTO_ROOT "${CMAKE_CURRENT_SOURCE_DIR}/../proto" ABSOLUTE)

    set(_protobuf_include_path -I ${PROTO_ROOT} -I . -I ${_gRPC_PROTOBUF_WELLKNOWN_INCLUDE_DIR})

    foreach(FIL ${ARGN})
        set(ABS_FIL "${PROTO_ROOT}/${FIL}")
